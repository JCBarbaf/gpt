class NewConversations extends HTMLElement {
    ...
    render () {
      ...
      <style>
        ...
        .new-conversation:hover{
          ...
          border: 1px solid rgba(32, 33, 34, 0.5);
          cursor: pointer;
        }
      ...
      <section class="new-conversations">
        <div class="new-conversation">
          <div class="new-conversation-model-icon">
          ...
          <div class="new-conversation-model-name">
            <span>chatDPM</span>
          </div>
  ...
  customElements.define('new-conversations-component', NewConversations);